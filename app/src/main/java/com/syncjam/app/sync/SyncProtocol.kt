...
sealed interface SyncCommand {
    ...
    data class TrackEnded(val trackId: String, val serverTimestampMs: Long = 0L) : SyncCommand
    ...
    /** Server → all: the host has disconnected; adminId is now the effective playback leader. */
